...
#define ILI9341 (9341)
#define LCD_ID  ILI9341 //LCD控制器型号
...
#define LCD_BITSPERPIXEL (16)    //颜色深度，16位
#define LCD_SWAP_RB       (1)    //红蓝反色交换

#define LCD_CONTROLLER (LCD_ID)//编译LCDDummy.c
...
#define   LCD_INIT_CONTROLLER() ILI9341_Init();//绑定底层LCD驱动
