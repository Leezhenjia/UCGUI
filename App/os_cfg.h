...
#define OS_TASK_SW_HOOK_EN        1u   /*     Include code for OSTaskSwHook()                          */
                                       ...
                                       /* ----------------------- EVENT FLAGS ------------------------ */
#define OS_FLAG_EN                1u   //禁用信号量集/* Enable (1) or Disable (0) code generation for EVENT FLAGS    */
...
#define OS_MUTEX_EN               1u   //禁用互斥信号量/* Enable (1) or Disable (0) code generation for MUTEX          */
...
#define OS_MUTEX_QUERY_EN         1u   /*     Include code for OSMutexQuery()                          */
                                       ...
                                       /* ---------------------- MESSAGE QUEUES ---------------------- */
#define OS_Q_EN                   1u   //禁用队列/* Enable (1) or Disable (0) code generation for QUEUES         */
...
#define OS_Q_QUERY_EN             1u   /*     Include code for OSQQuery()                              */
                                       ...
                                       /* ------------------------ SEMAPHORES ------------------------ */
#define OS_SEM_EN                 1u   //禁用信号量/* Enable (1) or Disable (0) code generation for SEMAPHORES     */
